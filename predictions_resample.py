...
data = pd.read_csv('insurance_data_without_privacy_train_small.csv', sep = ',', na_values=['(NA)']).fillna(0)
...
data = pd.read_csv('insurance_data_without_privacy_train_medium.csv', sep = ',', na_values=['(NA)']).fillna(0)
...
data = pd.read_csv('insurance_data_without_privacy_train.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
y_train_GAN = data[:,0]
...
data = pd.read_csv('insurance_data_without_privacy_train_e_13_small.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 1000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
...
data = pd.read_csv('insurance_data_without_privacy_train_medium_e_13.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
...
data = pd.read_csv('insurance_data_without_privacy_train_e_13.csv', sep = ',', na_values=['(NA)']).fillna(0) #3
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
y_train_13 = data[:,0]
...
data = pd.read_csv('insurance_data_without_privacy_train_e_3_small.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
...
data = pd.read_csv('insurance_data_without_privacy_train_medium_e_3.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
...
data = pd.read_csv('insurance_data_without_privacy_train_e_3.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
y_train_3 = data[:,0]
...
data = pd.read_csv('insurance_data_without_privacy_train_e_1_small.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 1000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
...
data = pd.read_csv('insurance_data_without_privacy_train_medium_e_1.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
...
data = pd.read_csv('insurance_data_without_privacy_train_e_1.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
y_train_1 = data[:,0]
...
data = pd.read_csv('insurance_data_without_privacy_train_e_05_small.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
...
data = pd.read_csv('insurance_data_without_privacy_train_e_05.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
y_train_05 = data[:,0]
...
data = pd.read_csv('insurance_data_without_privacy_train_e_005_small.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
...
data = pd.read_csv('insurance_data_without_privacy_train_e_005.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 1000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
y_train_005 = data[:,0]
...
data = pd.read_csv('insurance_data_without_privacy_train_e_001_small.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
...
data = pd.read_csv('insurance_data_without_privacy_train_e_001.csv', sep = ',', na_values=['(NA)']).fillna(0)
tuning = data.sample(n = 10000, random_state = 0)
data = np.array(data)
data = data.reshape(len(data),9)
y_train_001 = data[:,0]
